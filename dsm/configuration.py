...
CLASSIC_WEBSITE_MIGRATION_QUEUE_DEFAULT = os.environ.get(
    "CLASSIC_WEBSITE_MIGRATION_QUEUE_DEFAULT", 'default_priority')
CLASSIC_WEBSITE_MIGRATION_QUEUE_HIGH = os.environ.get(
    "CLASSIC_WEBSITE_MIGRATION_QUEUE_HIGH", 'high_priority')
CLASSIC_WEBSITE_MIGRATION_QUEUE_LOW = os.environ.get(
